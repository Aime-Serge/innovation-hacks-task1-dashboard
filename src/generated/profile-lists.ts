...
// config/profile_lists.json. Do not edit by hand (MF-02).

export type ListOption = { value: string; label: string };
export type CountryOption = { code: string; name: string };

export const DISCIPLINES: ListOption[] = [
  {
    "value": "backend",
    "label": "Backend"
  },
...
export const SENIORITIES: ListOption[] = [
  {
    "value": "student_intern",
    "label": "Student or intern"
  },
  {
    "value": "junior",
    "label": "Junior"
...
export const EMPLOYMENT_STATUSES: ListOption[] = [
  {
    "value": "employed",
    "label": "Employed"
  },
