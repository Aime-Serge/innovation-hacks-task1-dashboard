...
import { forgotPassword, MockAuthError } from "@/lib/mock-auth";
  ...
  if (result) {
    return (
      <div className="flex flex-col gap-4">
        ...
        {result.devResetUrl ? (
          <NoticeBanner message="Mocked: this demo has no email provider, so here's the reset link directly instead of emailing it." />
        ) : null}
        {result.devResetUrl && (
          <Link
